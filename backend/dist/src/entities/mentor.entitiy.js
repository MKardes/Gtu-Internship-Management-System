...
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Mentor.prototype, "surname", void 0);
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], Mentor.prototype, "phone_number", void 0);
exports.Mentor = Mentor = __decorate([
    (0, typeorm_1.Entity)("mentor"),
    (0, typeorm_1.Unique)(['id', 'mail'])
], Mentor);
//# sourceMappingURL=mentor.entitiy.js.map